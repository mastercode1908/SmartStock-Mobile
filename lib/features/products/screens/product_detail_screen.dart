...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  Color get _tertiaryContainer => Theme.of(context).colorScheme.tertiary;
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Theme.of(context).scaffoldBackgroundColor,
      appBar: AppBar(
        ...
        centerTitle: true,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.87)),
                              ...
                              child: product.imageUrl.isNotEmpty
                                  ? Image.network(
                                      ...
                                      errorBuilder: (context, error, stackTrace) =>
                                          Icon(Icons.image, size: 48, color: Theme.of(context).colorScheme.onSurfaceVariant),
                                    )
                                  : Icon(Icons.image, size: 48, color: Theme.of(context).colorScheme.onSurfaceVariant),
                            ),
                          ),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: 4),
                                          Text('loại', style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.54), fontSize: 13)),
                                        ],
                                      ),
                                    ],
                                  ),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text('PHƯƠNG THỨC THEO DÕI',
                                                style: TextStyle(
                                                    fontSize: 10, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.54), fontWeight: FontWeight.bold)),
                                            SizedBox(height: 2),
                                            Text(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                product.description,
                                style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.87), fontSize: 14, height: 1.4),
                              ),
                            ),
                          ],
                        ),
                            ...
                            Container(
                              ...
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.38), fontStyle: FontStyle.italic),
                                ),
                              ),
                            )
                          else
        ...
        children: [
                ...
                child: widget.variant.imageUrl.isNotEmpty
                    ? Image.network(
                        ...
                        errorBuilder: (context, error, stackTrace) => Container(
                          ...
                          child: Icon(Icons.widgets, color: Theme.of(context).colorScheme.onSurfaceVariant),
                        ),
                      )
                    : Container(
                        width: 52,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(fontSize: 13, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.87), fontFamily: 'JetBrains Mono'),
                    ),
                    ...
                    Wrap(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(fontSize: 13, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.54), fontWeight: FontWeight.bold),
                        ),
                        Text('|', style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.26), fontSize: 12)),
                        Text(
          ...
          if (variantUnits.isEmpty)
            Text(
              ...
              style: TextStyle(fontSize: 13, fontStyle: FontStyle.italic, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.38)),
            )
          else
            Wrap(
              spacing: 8,
              ...
              children: variantUnits.map((pu) {
                return Chip(
                  label: Text(
                    ...
                    style: TextStyle(fontSize: 13, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.87), fontWeight: FontWeight.bold),
                  ),
